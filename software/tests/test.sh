...
echo "Testing SHA different buffer sizes"
...
echo "Testing AES different buffer sizes"
...
xxd -p AES_101.txt | head -c 64
xxd -p AES_167.txt | head -c 64
xxd -p AES_397.txt | head -c 64
xxd -p AES_DEFAULT.txt | head -c 64
...
echo ""
xxd -p priv1.txt | head -c 64
xxd -p priv1.txt | tail -c 64
xxd -p pub1.txt  | head -c 64
...
echo ""
xxd -p priv2.txt | head -c 64
xxd -p priv2.txt | tail -c 64
xxd -p pub2.txt  | head -c 64
