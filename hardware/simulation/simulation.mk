...
ifeq ($(SIM_SERVER),)
	...
	rsync -avz --delete --force --exclude .git --exclude=submodules/VEXRISCV/VexRiscv --exclude=submodules/VEXRISCV/buildroot $(SIM_SYNC_FLAGS) $(ROOT_DIR) $(SIM_USER)@$(SIM_SERVER):$(REMOTE_ROOT_DIR)
